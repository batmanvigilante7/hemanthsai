  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mt-12 hidden items-center gap-8 lg:grid lg:grid-cols-[minmax(620px,760px)_1fr] xl:gap-12">
