...
export default function App() { return <main className="min-h-screen overflow-x-clip bg-[#050505]"><Hero /><Divider text="DISCIPLINE" /><IdentityStack /><Divider text="PRESSURE" /><Proof /><System /><Divider text="EXECUTION" /><Work /><Capabilities /><Obsessions /><BeforeCode /><Contact /></main>; }
