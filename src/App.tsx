  ...
  return (
    <div className={`noise group relative overflow-hidden bg-white/[0.04] ${className}`}>
      {!broken ? (
        ...
        <div className="flex h-full min-h-[260px] w-full items-center justify-center bg-[linear-gradient(135deg,#171717,#050505)]">
      ...
      <div className="absolute inset-0 shadow-[inset_0_0_150px_rgba(0,0,0,0.86)]" />
    </div>
  );
}
...
function Button({ children, href = '#' }: { children: ReactNode; href?: string }) {
  return (
    <a
      href={href}
      className="liquid-glass group inline-flex items-center gap-3 rounded-full px-6 py-3 text-sm font-semibold uppercase tracking-[0.2em] text-white transition duration-300 hover:scale-[1.03] hover:bg-white/[0.07]"
    >
      {children}
...
function Divider({ text }: { text: string }) {
  return (
    <section className="relative overflow-hidden border-y border-white/10 bg-[#050505] py-14 sm:py-20">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.07),transparent_55%)]" />
      <div className="relative flex animate-marquee-left whitespace-nowrap text-[18vw] font-black uppercase leading-none tracking-[-0.08em] text-white/[0.08] sm:text-[10vw]">
...
function Hero() {
  ...
  return (
    <section id="arrival" className="noise relative min-h-screen overflow-hidden bg-[#050505] text-white">
      ...
      <nav className="fixed left-0 right-0 top-0 z-40 px-4 py-4 sm:px-8">
        <div className="liquid-glass mx-auto flex max-w-7xl items-center justify-between rounded-full px-5 py-3">
          <a href="#arrival" className="font-black uppercase tracking-[-0.04em]">
      ...
      {open && (
        <div className="fixed inset-0 z-30 bg-black/95 px-8 pt-28 backdrop-blur-xl lg:hidden">
          {navLinks.map((link) => (
            <a
              onClick={() => setOpen(false)}
              key={link.label}
              href={link.href}
              className="block border-b border-white/10 py-6 text-4xl font-black uppercase tracking-[-0.06em]"
            >
              {link.label}
            </a>
          ))}
      ...
      <div className="relative z-10 mx-auto grid min-h-screen max-w-7xl items-end gap-8 px-5 pb-10 pt-28 md:grid-cols-[1.1fr_0.9fr] md:px-10">
        <div>
          <FadeIn>
            <p className="mb-5 flex flex-wrap items-center gap-3 text-xs uppercase tracking-[0.32em] text-white/60">
          ...
          <motion.h1
            ...
            className="max-w-[10ch] text-[18vw] font-black uppercase leading-[0.78] tracking-[-0.09em] text-white sm:text-[13vw] md:text-[8.2rem]"
          >
          ...
          <FadeIn delay={0.25}>
            <div className="mt-7 flex flex-wrap items-center gap-3">
              <span className="liquid-glass inline-flex items-center gap-3 rounded-full px-4 py-3 text-xs uppercase tracking-[0.22em] text-white/70">
        ...
        <FadeIn delay={0.1} className="relative mx-auto w-full max-w-[430px]">
          <div className="absolute inset-8 rounded-full bg-white/10 blur-3xl" />
          <ImageFrame
            src={images.hero}
            alt="Hemanth Sai cutout portrait"
            label="Hero portrait"
            className="relative aspect-[0.86] rounded-[3rem] border border-white/10"
...
function Identity() {
  return (
    <section id="identity" className="bg-[#070707] px-5 py-24 text-white sm:px-8 md:px-10">
      <div className="mx-auto max-w-7xl">
        <FadeIn>
          <h2 className="text-[18vw] font-black uppercase leading-none tracking-[-0.09em] text-white/10 md:text-[9rem]">
            Identity
          </h2>
        </FadeIn>
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <ImageFrame
            ...
            label="Martial arts"
            className="min-h-[520px] rounded-[3rem] border border-white/10"
          />

          <div className="flex flex-col justify-end">
            <FadeIn>
              <p className="max-w-4xl text-3xl font-light leading-[1.1] tracking-[-0.05em] text-white/85 md:text-5xl">
            ...
            <FadeIn delay={0.18}>
              <ImageFrame
                ...
                className="mt-6 h-[310px] rounded-[2.2rem] border border-white/10"
              />
            </FadeIn>
          </div>
        </div>
...
function Glass({ title, text }: { title: string; text: string }) {
  return (
    <div className="liquid-glass rounded-[2rem] p-6">
      <h3 className="mb-3 text-xl font-black uppercase tracking-[-0.04em]">{title}</h3>
...
function Pressure() {
  return (
    <section id="pressure" className="relative min-h-screen overflow-hidden bg-black text-white">
      <ImageFrame
        src={images.shotput}
        alt="Shotput action"
      ...
      <div className="relative z-10 flex min-h-screen items-end px-5 pb-16 sm:px-10">
        <FadeIn>
          <p className="mb-5 text-xs uppercase tracking-[0.34em] text-white/55">
            Forged under pressure
          </p>
          <h2 className="max-w-6xl text-6xl font-black uppercase leading-[0.82] tracking-[-0.08em] sm:text-8xl md:text-[10rem]">
...
function Proof() {
  return (
    <section id="proof" className="bg-white px-5 py-24 text-black sm:px-8 md:px-10">
      <div className="mx-auto max-w-7xl">
        <FadeIn>
          <p className="mb-4 text-xs uppercase tracking-[0.32em] text-black/40">
            Proof dashboard
          </p>
          <h2 className="max-w-5xl text-5xl font-black uppercase leading-[0.9] tracking-[-0.08em] sm:text-7xl md:text-8xl">
        ...
        <div className="mt-14 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {dashboard.map((item, index) => (
            <FadeIn key={item.title} delay={index * 0.05}>
              <div className="min-h-[220px] rounded-[2rem] border border-black/10 bg-black/[0.035] p-7">
                <p className="mb-8 text-xs uppercase tracking-[0.28em] text-black/35">
                  0{index + 1}
                </p>
                <h3 className="mb-3 text-2xl font-black uppercase tracking-[-0.05em]">
                  {item.title}
                </h3>
                <p className="leading-relaxed text-black/60">{item.text}</p>
              </div>
            </FadeIn>
          ))}
        </div>
...
function System() {
  const steps = ['Obsession', 'Structure', 'Critique', 'MVP', 'Proof', 'Feedback', 'Iteration'];

  return (
    <section id="system" className="bg-[#050505] px-5 py-24 text-white sm:px-8 md:px-10">
      <div className="mx-auto max-w-7xl">
        <FadeIn>
          <h2 className="text-[16vw] font-black uppercase leading-none tracking-[-0.09em] text-white/10 md:text-[8rem]">
            The System
          </h2>
          <p className="mt-6 max-w-3xl text-2xl font-light leading-relaxed text-white/75">
        ...
        <div className="hide-scrollbar mt-14 flex snap-x gap-4 overflow-x-auto pb-5">
          {steps.map((step, index) => (
            <div key={step} className="liquid-glass min-w-[260px] rounded-[2rem] p-7">
              <p className="text-6xl font-black text-white/15">0{index + 1}</p>
...
function ProjectCard({ project, index, total }: { project: Project; index: number; total: number }) {
  ...
  return (
    <div
      ref={ref}
      className="relative h-[108vh] min-h-[820px]"
      style={{ marginTop: index === 0 ? 0 : '-58vh' }}
    >
      <motion.article
        style={{ scale, top: `${86 + index * 22}px`, zIndex: 30 + index }}
        className="sticky overflow-hidden rounded-[2.5rem] border border-white/10 bg-[#090909] p-6 shadow-[0_80px_220px_rgba(0,0,0,0.78)] md:rounded-[4rem] md:p-10"
      >
        <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
          <span className="text-8xl font-black tracking-[-0.08em] text-white/15">
            {project.number}
          </span>
          ...
          <div className="max-w-3xl">
            ...
            <h3 className="mt-3 text-5xl font-black uppercase leading-none tracking-[-0.07em] md:text-7xl">
              {project.name}
            </h3>
            <p className="mt-5 text-lg leading-relaxed text-white/62">{project.description}</p>
            <div className="mt-6 flex flex-wrap gap-3">
              {project.tags.map((tag) => (
                <span
                  key={tag}
                  className="rounded-full border border-white/10 px-4 py-2 text-xs uppercase tracking-[0.2em] text-white/55"
                >
                  {tag}
                </span>
              ))}
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-3">
          {[0, 1, 2].map((item) => (
            <div
              key={item}
              className="h-44 rounded-[2rem] border border-white/10 bg-[linear-gradient(135deg,#171717,#050505)] md:h-64"
            />
          ))}
        </div>
      </motion.article>
...
function Work() {
  return (
    <section id="work" className="bg-[#050505] px-5 py-24 text-white sm:px-8 md:px-10">
      <div className="mx-auto max-w-7xl">
        <FadeIn>
          <h2 className="text-[18vw] font-black uppercase leading-none tracking-[-0.09em] text-white/10 md:text-[9rem]">
            Work
...
function Capabilities() {
  return (
    <section className="bg-white px-5 py-24 text-black sm:px-8 md:px-10">
      <div className="mx-auto max-w-7xl">
        <FadeIn>
          <h2 className="text-5xl font-black uppercase leading-[0.9] tracking-[-0.08em] sm:text-7xl md:text-8xl">
            Capability pillars.
          </h2>
        </FadeIn>
        ...
        <div className="mt-14 grid gap-4 lg:grid-cols-5">
          {pillars.map((pillar) => {
            ...
            return (
              <div key={pillar.title} className="rounded-[2rem] border border-black/10 bg-black/[0.035] p-6">
...
function Obsessions() {
  return (
    <section className="bg-[#050505] px-5 py-24 text-white sm:px-8 md:px-10">
      <div className="mx-auto max-w-7xl">
        <FadeIn>
          <p className="mb-4 text-xs uppercase tracking-[0.32em] text-white/40">
            Current obsessions
          </p>
          <h2 className="max-w-4xl text-5xl font-black uppercase leading-[0.9] tracking-[-0.08em] sm:text-7xl md:text-8xl">
        ...
        <div className="mt-14 grid gap-4 md:grid-cols-2">
          {obsessions.map((obsession, index) => (
            <FadeIn key={obsession} delay={index * 0.04}>
              <div className="liquid-glass flex items-center justify-between rounded-[2rem] px-6 py-6">
                <span className="text-2xl font-semibold tracking-[-0.05em]">{obsession}</span>
                <span className="text-xs uppercase tracking-[0.24em] text-white/35">Active</span>
              </div>
            </FadeIn>
          ))}
        </div>
    ...
    <section className="bg-white px-5 py-24 text-black sm:px-8 md:px-10">
      <div className="mx-auto max-w-7xl">
        <FadeIn>
          ...
          <p className="mt-6 max-w-2xl text-lg text-black/55">
        ...
        <div className="mt-14 grid gap-4 md:grid-cols-5">
          <ImageFrame src={images.martial} alt="Martial arts" label="Martial arts" className="h-80 rounded-[2rem] md:col-span-2" />
          <ImageFrame src={images.stage} alt="Stage" label="Stage" className="h-80 rounded-[2rem] md:col-span-3" />
          <ImageFrame src={images.shotput} alt="Shotput" label="Shotput" className="h-96 rounded-[2rem] md:col-span-3" />
          <ImageFrame src={images.blazer} alt="Blazer" label="Blazer" className="h-96 rounded-[2rem] md:col-span-2" />
        </div>
      </div>
    </section>
  );
...
function Contact() {
  return (
    <section id="contact" className="bg-[#050505] px-5 py-24 text-white sm:px-8 md:px-10">
      <div className="liquid-glass mx-auto grid max-w-7xl overflow-hidden rounded-[2.5rem] md:grid-cols-[0.9fr_1.1fr] md:rounded-[4rem]">
        <ImageFrame src={images.blazer} alt="Blazer portrait" label="Blazer portrait" className="min-h-[520px]" />

        <div className="flex flex-col justify-center p-8 md:p-16">
          <FadeIn>
            <h2 className="text-5xl font-black uppercase leading-[0.85] tracking-[-0.08em] sm:text-7xl md:text-8xl">
