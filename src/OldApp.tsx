...
const identitySignals = [
  {
    ...
    story: 'Structure is the part of me that came before ambition. It is the habit of respecting routines, showing up with presence, and understanding that standards are not decoration ΓÇö they are the operating system. This signal connects Sainik School, NCC, and every environment that taught me to take myself seriously before asking the world to do the same.',
...
const dashboard = [
  ...
  ['Learning Loop', 'Project ΓåÆ Problem ΓåÆ Skill ΓåÆ Artifact ΓåÆ Explanation ΓåÆ Feedback'],
      ...
      <div className="relative mx-auto max-w-7xl">
        <FadeIn>
          ...
          <p className="mt-5 max-w-4xl text-base leading-relaxed text-white/56 sm:text-lg">
            The environments changed ΓÇö training grounds, uniforms, stages, classrooms, and laptops ΓÇö but
      ...
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <FadeIn className="order-2 lg:order-1">
          ...
          <p className="mt-5 max-w-2xl text-base leading-relaxed text-white/68 sm:mt-6 sm:text-lg">
            Pressure has been one of my oldest teachers ΓÇö from sports and martial arts to leadership and building.
